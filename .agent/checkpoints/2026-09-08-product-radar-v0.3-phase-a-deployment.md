...
- Source commits: `16d756d` (V0.3 Phase A), `f360e2d` (per-query shared-feed target validation), `8b0b96e` (TargetProfile/SearchPlan persistence).
...
- LangBot plugin: `product-radar` `0.3.0`, install task `40`, `INSTALL_READY`; plugin deploy rollback directory `.backups/langbot/20260908-130039`.
