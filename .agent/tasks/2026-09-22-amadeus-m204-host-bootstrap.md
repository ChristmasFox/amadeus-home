...
5. Install Docker/CasaOS in the clean `nyannyan` guest using the tracked clean-guest plan, then verify Docker, Docker Compose and `/DATA/AppData`. Do not start OpenClaw or restore data at this step.
...
8. Secret/data restore, CasaOS startup, external-channel routing, and cutover each require their separate tracked preflight/checkpoint and explicit apply boundary.
