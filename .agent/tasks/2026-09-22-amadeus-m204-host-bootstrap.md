...
- Git is present. Homebrew, OrbStack/Docker, Node, pnpm, clean monorepo and Avalon mount are absent; Python is 3.9.6.
...
2. Install OrbStack, Node 24, pnpm and Python 3.11+; verify architecture remains arm64.
...
5. Only after the above succeed, follow the tracked clean-guest plan to create OrbStack Ubuntu 24.04 machine `nyannyan`. Do not import the old `ubuntu` guest.
