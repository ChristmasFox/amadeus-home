...
状态：ACTIVE / P0_COMPLETE_LOCAL / P1_COMPLETE_LOCAL / P2_NEXT。用户要求先提交实施计划，随后由本机 Codex Goal 完成 P0–P6；P7 仍未授权。
