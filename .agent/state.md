...
- 2026-09-24 WhatsApp relink completed: M204 reports Telegram `ready/connected` and WhatsApp `linked/healthy/connected`. The detached relink worker and its child login processes were stopped after successful linking. Both channel accounts still have no real inbound/outbound activity timestamps, so do not claim owner acceptance, duplicate-response absence, or final cutover until actual channel messages are observed.
