...
- Product Radar implementation commits are `83c3557` and `ed394e9`; 本阶段未部署 Docker/CasaOS、未安装 LangBot plugin、未向 Telegram/KOOK 发送测试消息；见 `.agent/checkpoints/2026-09-07-product-radar-v0.1.md`。
