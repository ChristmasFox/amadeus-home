...
python3 -m py_compile apps/qwen3-tts-service/*.py infra/macos/render-qwen3-tts-plist.py infra/macos/verify-qwen3-mlx-assets.py scripts/audit-qwen-b-reference.py scripts/align-qwen-b-reference.py
python3 scripts/test-audit-qwen-b-reference.py
python3 scripts/test-align-qwen-b-reference.py
