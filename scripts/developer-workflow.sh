...
for path in "${FILES[@]-}"; do
  ...
  case "$path" in
    ...
    scripts/prepare-mlx-tts-poc.sh|scripts/audit-qwen-b-reference.py|scripts/test-audit-qwen-b-reference.py|scripts/align-qwen-b-reference.py|scripts/test-align-qwen-b-reference.py) has_speech=1 ;;
