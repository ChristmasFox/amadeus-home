...
- Release system definitions from Git; keep secrets, databases, retired-service data, and volumes
...
- Amadeus/OpenClaw releases use `scripts/deploy-openclaw.sh --dry-run`; only an explicit
  `--apply --build` may create the immutable image and switch CasaOS.
