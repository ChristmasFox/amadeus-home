...
- Owner rejected D's loss of character, then compared exact A/MPS and A/MLX direct samples, found A+MLX acceptable and requested a controlled implementation; live backend remains A/MPS/Auto until candidate apply, and confirmed candidate WhatsApp one Japanese PTT, nonduplicated visible text and typed input without TTS. Two real candidate voice turns had TTS 9.33s/9.91s and inbound→media 22.58s/20.74s; no real p95 claim.
