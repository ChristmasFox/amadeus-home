...
- **MLX 1.7B 8-bit** is conditionally selected for A only after direct owner listening; cold/real A footprint peak 18.4 GiB, temporary swap growth and community dependency upkeep are candidate gates, not hidden costs. **0.6B** was unnecessary and not substituted. **Direct Ogg/Opus** remains optional/not switched: measured MP3 encode ~0.03–0.37s and native WhatsApp PTT/MIME/duration equivalence across channels was not proven.
